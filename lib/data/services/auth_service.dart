...
class AuthService {
  ...
  Future<User?> signUpWithEmail({required String email, required String password, required String displayName}) =>
      _emailAuth.signUp(email: email, password: password, displayName: displayName);
  // Google
