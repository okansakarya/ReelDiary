      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              height: ScreenUtils.getScreenHeight(context) * 0.001,
            ),
            Align(
              alignment: Alignment.centerRight,
              child: TextButton(
                onPressed: () {
                  // Şifremi unuttum işlemi buraya
            ...
            BlocConsumer<AuthCubit, AuthState>(
              listener: (context, state) {
                if(state is Authenticated){
                  _navigateBack();
                  PopUpUtils.showPopup(context, true, successMessage: 'Giriş Başarılı!', failureMessage: '');
                }
